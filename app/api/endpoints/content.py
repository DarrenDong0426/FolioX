...
@content_bp.route("/admin/content/upload-pdf", methods=["POST"], strict_slashes=False)
def upload_content_pdf():
    ...
    safe_name = f"pdfs/{uuid.uuid4().hex[:8]}_{clean_filename}"
    file_bytes = f.read()
