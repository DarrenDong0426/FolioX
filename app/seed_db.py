...
projects = [
    ...
    },
    {
        ...
        "lock": True,
        "wip": False,
        "month_year": date(2023, 9, 28),
        "language": ["C"],
        "type": ["Software"]
    },
    {
        "name": "Intro to Computer Organization (EECS 370): Multi-cycle Pipeline",
...
events = [
    ...
    },
    {
        ...
        "description": """Traveling to Japan for 2 weeks with friends to explore the culture, food, and sights of Tokyo, Kyoto, Osaka, and Hiroshima.""",
        "tags": "Personal",
        "start": date(2025, 5, 1),
        "end": date(2025, 5, 15),
        "images": [
            "/events/japan2025/japan1.jpg",
            "/events/japan2025/japan2.jpg",
            "/events/japan2025/japan3.jpg",
            "/events/japan2025/japan4.jpg",
            "/events/japan2025/japan5.jpg",
            "/events/japan2025/japan6.jpg",
            "/events/japan2025/japan7.jpg",
            "/events/japan2025/japan8.jpg",
            "/events/japan2025/japan9.jpg"
        ]
    }
]
    ...
    for proj in projects:
        conn.execute(
            text("""
                ...
                VALUES (:name, :description, :lock, :wip, :month_year, :language, :type)
                """),
                {
                    "name": proj["name"],
    ...
    for doc in documents:
        conn.execute(
            text("""
                    ...
                    VALUES (:title, :description, :last_updated, :file_path)
                """),
            doc
        )
    ...
    for event in events:
        conn.execute(
            text("""
                ...
                VALUES (:title, :description, :tags, :start, :end, :images)
            """),
                {
                    "title": event["title"],
